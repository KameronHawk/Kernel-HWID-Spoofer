...
#include <ntddscsi.h>
#include <ntdddisk.h>
extern ULONG NumOfDisk;
extern PDEVICE_OBJECT* Devices;

#define VOLUME_GUID_MAX_LENGTH (0x24)
#define MAX_PARTITIONS 128
#define MAX_HARDDRIVES 10 // if anyone has more than 10 hard drives theyre fucking insane? Hello?
#define DISK_SERIAL_MAX_LENGTH 40
#define MAX_DISK_SERIALS 15
